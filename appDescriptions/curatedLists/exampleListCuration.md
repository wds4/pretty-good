...
In this example, a list of nostr clients has been created and curated. The results of curation are shown below from the perspectives of two different users: 
- wds4, a regular user
