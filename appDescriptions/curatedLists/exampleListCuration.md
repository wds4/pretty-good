...
From the above endorsements, each submitted list item is either ACCEPTED, REJECTED or PENDING (not enougn info) as belonging to the list. But if Alice and Bob don't "trust" the same people to curate this list, they may not see the same results!
