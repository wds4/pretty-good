...
const MakeNewListState = () => {
  ...
  const [existingListSearchTerm, setExistingListSearchTerm] = useState(''); // use to add another list
    ...
    <>
      <div>
        ...
        <div style={{display: "block", fontSize: "12px"}}>
          ...
          <div>existingListSearchTerm: {existingListSearchTerm}</div>
        ...
        <MakeNewListFunctions
          ...
          existingListSearchTerm={existingListSearchTerm}
