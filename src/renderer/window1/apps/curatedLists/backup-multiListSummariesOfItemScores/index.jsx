...
import ScoresSummaries from './scoresSummaries';

export default class MultiListSummariesOfItemScores extends React.Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
  ...
  async componentDidMount() {
    updateMainColWidth();
    const mastheadDescriptor = 'Scores Overview';
    ...
    return (
      <>
        ...
        <div id="mainCol">
          <Masthead />
          <div id="mainPanel">
            <div className="h4">Item Scores for Each List</div>
            <ScoresSummaries />
          </div>
        </div>
      </>
