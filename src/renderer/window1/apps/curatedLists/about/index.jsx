...
export default class ConceptGraphSettings extends React.Component {
  ...
  async componentDidMount() {
    updateMainColWidth();
    const mastheadDescriptor = 'About Curated Lists';
    ...
    return (
      <>
        ...
        <div id="mainCol">
          <Masthead />
          <div id="mainPanel">
            <div className="h4">About Curated Lists</div>
            ...
            <p>
              ...
              <li>
                Alice endorses an instance (without specifying what the
                endorsement means).
              </li>
              <li>
                Alice endorses Bob's trustworthiness to rate instances of this
                list. (TRANSITIVE) (Hardware Wallets).
              </li>
            </p>
            ...
            <p>
              ...
              <li>
                ...
                "Alice endorse's Bob's ability to rate other people's ability to
                rate Hardware Wallets." (TRANSITIVE)
              </li>
            </p>
          </div>
        </div>
