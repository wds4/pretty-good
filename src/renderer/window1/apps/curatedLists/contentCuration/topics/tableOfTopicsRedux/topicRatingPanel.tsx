...
const createRatingWord = (
  ...
  let wordSlug = "ratingOf_"+instanceSlug+ "-"+instance_event_id.substr(-4);
...
const TopicRatingPanel = ({oWord, event, event_id, oNostrNodesByEventID}) => {
  ...
  return (
    <>
      <div style={{display:'inline-block', padding: '5px'}}>
        ...
        <div className={devElemClass} style={{border: '1px dashed grey', width: '100%'}}>
          <br />
          <textarea style={{fontSize:'12px'}} id={newConceptRawFileFieldElem}></textarea>
          <div
...
export default TopicRatingPanel;
