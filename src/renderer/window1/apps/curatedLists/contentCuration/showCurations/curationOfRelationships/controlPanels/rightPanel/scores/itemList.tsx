...
import { updateCuratedChannelsRelationships } from 'renderer/window1/redux/features/nostr/myNostrProfile/slice';
      ...
      <div style={{textAlign: 'left', marginLeft: '25px', marginBottom: '3px'}}>
        ...
        <button
          ...
          onClick={()=>{
            ...
            dispatch(updateCuratedChannelsRelationships(aAcceptedEventIDs));
          }}
