    ...
    <>
      <div className={devElemClass}>
        <div>
          ...
          word wrapped into a nostr event
        </div>
        <div
          id={elem_id}
          style={{
        ...
        >
          <div>
            See <a style={{textDecoration: 'none'}} href="https://github.com/wds4/DCoSL/blob/main/dips/conceptGraph/101.md" target="_blank">DIP-101</a>
          </div>
