...
const FollowingForRelays = () => {
  ...
  const aProfiles = myNostrProfile.endorseAsRelaysPickerHunter;
  const oRecRelays = {};
  const aRecRelays = [];
  ...
  return (
    <>
      <div style={{ width: '100%', border: '1px dashed grey', padding: '5px' }}>
        <div className="h4">Endorse as Relays Picker Hunters</div>
        list of the profiles I am endorsing as relay picker hunter; number:{' '}
        {aProfiles.length}
        <div>
          {aProfiles.map((pk) => {
            return (
