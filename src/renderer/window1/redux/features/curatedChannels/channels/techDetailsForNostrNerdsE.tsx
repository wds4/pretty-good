...
const TechDetailsForNostrNerds = ({oGrapevine}) => {
  ...
  const elem_id = "technicalDetailsForNostrDevsContainerE"; // add event_id or some other unique identifier if multiple details per page
    ...
    <>
      <div className={devElemClass}>
        <div>
          ...
          <span>channels.grapevine.byRatingTemplateSlug</span>
        </div>
        <div
          id={elem_id}
          style={{
        ...
        >
          <div>
            <div>channels.grapevine.byRatingTemplateSlug =</div>
            <div>{JSON.stringify(oGrapevine.byRatingTemplateSlug,null,4)}</div>
          </div>
        </div>
      </div>
    </>
